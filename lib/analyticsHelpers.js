...
export function buildDateRange(range, tz = "Asia/Kolkata") {
...
export function buildGroupFormat(range) {
...
export async function aggregateRange(start, end, groupFormat, tz = "Asia/Kolkata") {
...
export function generateLabels(start, end, unit, tz = "Asia/Kolkata") {
  const labels = [];
...
export function fillSeries(aggArray, labels) {
  const map = new Map();
...
export function compareSeries(currentSeries, previousSeries) {
